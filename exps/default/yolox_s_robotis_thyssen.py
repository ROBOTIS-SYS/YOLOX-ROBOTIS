...
# operation
# python3 tools/train.py -f exps/default/yolox_s_robotis_thyssen.py -d 2 -b 8 -o --cache
# python3 tools/train.py -f exps/default/yolox_s_robotis_thyssen.py -c ./model/yolox_s.pth -d 2 -b 8 -o --cache
...
class Exp(MyExp):
    def __init__(self):
        ...
        self.num_classes = 32
        self.data_dir = "/home/robotis-workstation3/ai/dataset/robotis_thyssen_coco"
